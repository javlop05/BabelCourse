...
var ContactosResolveService = (function () {
    function ContactosResolveService(_contactosService) {
        this._contactosService = _contactosService;
    }
    ContactosResolveService.prototype.resolve = function (route) {
        return this._contactosService.obtenerContactos();
    };
    return ContactosResolveService;
}());
ContactosResolveService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [contactos_service_1.ContactosService])
], ContactosResolveService);
exports.ContactosResolveService = ContactosResolveService;
